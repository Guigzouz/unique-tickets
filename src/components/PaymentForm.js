...
const PaymentForm = ({ userId, eventId, navigation, docSnap, ticketCounts, ticketCategories, addTicketToFirebase}) => {
  ...
  const handleSubmit = () => {
    if (cardNumber === '' || expiryDate === '' || cvv === '' || name === '') {
      ...
      addTicketToFirebase({ userId, eventId, ticketCategories, ticketCounts });
